        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {reviews.map((review, index) => (
            <div
              ...
              className="group bg-white rounded-xl border border-slate-200 overflow-hidden hover:border-blue-400 hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-lg cursor-default"
            >
